                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary viewbtn"
                                                        ...
                                                        data-presales1="<?php echo htmlspecialchars($bid['Presales1'] ?? 'null'); ?>"
                                                        data-presales2="<?php echo htmlspecialchars($bid['Presales2'] ?? 'null'); ?>"
                                                        data-presales3="<?php echo htmlspecialchars($bid['Presales3'] ?? 'null'); ?>"
                                                        data-presales4="<?php echo htmlspecialchars($bid['Presales4'] ?? 'null'); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.viewbtn', function() {
                ...
                console.log("presales1", presales1);
                console.log("presales2", presales2);
                console.log("presales3", presales3);
                console.log("presales4", presales4);
