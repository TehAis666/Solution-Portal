...
try {
    // Assuming staffID and name are stored in the session
    $staffID = $_SESSION['user_id'];
    $name = $_SESSION['user_name'];

    // Single query to fetch both types of bids with a role label
    $stmt = $conn->query("
      SELECT 
          b.*, 
          t.*, 
      ...
      WHERE b.staffID = $staffID
         OR '$name' IN (t.presales1, t.presales2, t.presales3, t.presales4)
  ");
